...
| 5 | **Яндекс.Метрика:** `NEXT_PUBLIC_YANDEX_METRICA_ID` в прод `.env` + сборка; цели в интерфейсе; при необходимости OAuth **metrika:read** для `scripts/yandex-metrica.mjs` | [ ] |
