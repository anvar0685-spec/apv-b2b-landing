...
const jobs = [
  ...
  // 03 «Линия комплектации» — реальный кадр: бригада в светоотражающих жилетах
  { src: path.join(SRC_DIR, "2A3FCDE0-C7B5-4FE7-8A1C-F6853F4AC15A.jpg"), out: "03-liniya-komplektacii.jpg", w: 1280, h: 960, q: 80, pos: "centre" },
