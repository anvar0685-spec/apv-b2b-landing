  ...
  return (
    <MarketingHeroChrome className="py-0 lg:py-0" innerClassName="relative mx-auto max-w-content px-4 pb-10 pt-10 sm:px-6 sm:pb-12 sm:pt-12 lg:px-8">
      <div className="min-w-0 max-w-3xl">
        ...
        <h1 className="font-display mt-4 max-w-[22ch] text-balance text-4xl font-bold leading-[1.1] tracking-[-0.035em] text-[var(--primary)] dark:text-white md:max-w-[32ch] md:text-5xl lg:text-[2.75rem]">
          {title}
        </h1>
...
export function CommercialVerticalHero({ crumbs, kicker, title, lead, children }: HeroProps) {
  return (
    <section className="ux-tech-field-light relative overflow-hidden border-b border-[var(--neutral-200)] bg-[var(--surface)] dark:border-white/10 dark:bg-[var(--primary-dark)]">
      ...
      />
      <div
        className="pointer-events-none absolute bottom-0 left-0 top-0 z-[2] w-[5px] bg-gradient-to-b from-[var(--accent)] via-[color-mix(in_srgb,var(--accent)_65%,var(--primary))] to-[var(--primary)] opacity-[0.92]"
        aria-hidden
      />
