...
export const recruitingPage: ServicePageBilingual = {
  ...
  ru: {
    ...
    intro: [
      ...
      "Мы проектируем воронку под профили грузчиков, комплектовщиков, операторов погрузчика и смежных ролей; дальше — либо вывод на объект в модели подряда по сменам, либо передача по согласованной схеме.",
    ...
    howItWorks: [
      ...
      "Передача в подряд по сменам или согласованная модель на стороне заказчика.",
    ],
    includes: [
