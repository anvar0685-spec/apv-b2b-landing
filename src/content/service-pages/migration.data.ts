...
export const migrationPage: ServicePageBilingual = {
  ...
  ru: {
    ...
    intro: [
      ...
      "Мы выстраиваем чек-листы, **таблицу ответственности** и регламент эскалаций до выхода сотрудника на смену — чтобы линейный руководитель не оставался один на один с формальными рисками.",
    ...
    segments: [
      ...
      { title: "3PL и распределительные центры", text: "Сменность под график у ворот, кросс-док, учёт по объектам и сменам." },
    ...
    howItWorks: [
      ...
      "Регламент и таблица ответственности.",
