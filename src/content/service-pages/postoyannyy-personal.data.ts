...
export const postoyannyyPersonalPage: ServicePageBilingual = {
  ...
  ru: {
    ...
    intro: [
      "Постоянное закрытие смен подходит распределительным центрам и хабам с ровным профилем: понятные пики, согласованный резерв и обучение людей без еженедельной пересборки состава.",
      ...
      "Длинный горизонт оправдан, когда в одном отчёте сходятся стоимость смены, явка и выработка линии: еженедельный разбор по факту из WMS, а не по ощущениям на планёрке — так проще держать смету по кварталу.",
    ...
    faq: [
      ...
      { q: "Нужен ли ограниченный старт?", a: "Рекомендуем для калибровки метрик и регламентов на первых сменах." },
      { q: "Как стартовать?", a: "Заявка или калькулятор — далее созвон с операционным менеджером." },
      { q: "Постоянный — значит весь штат вне штата заказчика?", a: "Нет: речь о долгом договоре на закрытие смен подрядчиком с устойчивым планом и контактом; нюансы формы взаимодействия — в договоре, не в абзаце на сайте." },
