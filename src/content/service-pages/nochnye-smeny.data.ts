...
export const nochnyeSmenyPage: ServicePageBilingual = {
  ...
  ru: {
    ...
    segments: [
      { title: "Приёмка ночью", text: "Разгрузка и приёмка при ограниченном контроле дневной смены." },
      { title: "Комплектация", text: "Стабильная скорость линий при сниженной освещённости и мониторинге ошибок." },
      { title: "Отгрузка к утру", text: "Подготовка партий к дневным окнам отгрузки без простоя ворот." },
      { title: "Сервисные роли", text: "Уборка зон, внутренняя логистика, подсобка на ночном графике." },
    ],
    howItWorks: [
      "Карта рисков ночной смены и профиль людей.",
      "Регламент инструктажей, менторинг и резерв.",
      "Старт на ограниченной зоне с ночными метриками.",
