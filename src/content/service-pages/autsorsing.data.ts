...
export const autsorsingPage: ServicePageBilingual = {
  ...
  ru: {
    ...
    intro: [
      ...
      "Калькулятор на сайте даёт быстрый оценочный фонд по часам и ставкам; пошаговая заявка передаёт параметры менеджеру — в ответ КП с разложением по профилям, ночным окнам, резерву замены и формату отчётности (ежесменно / еженедельно). Фиксируем не только цену, но и время реакции на замену, порог явки, работу в выходные и порядок эскалации при повторяющихся срывах.",
