...
export const GARANTII_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Политика обработки персональных данных (/politika-konfidencialnosti), публичная оферта (/oferta), согласие на ПДн (/soglasie-na-obrabotku-pd) и правила сайта (/pravila-saita) задают общий контур обращения с данными, акцепта и использования сервисов, но не расширяют гарантии поставщика сверх согласованного в вашем договоре с ИП/контрагентом АПВ — СИСТЕМА.",
