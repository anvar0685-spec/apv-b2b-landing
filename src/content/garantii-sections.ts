...
export const GARANTII_SECTIONS: LegalSection[] = [
  {
    ...
    paragraphs: [
      ...
      "Показатели доступности команды сопровождения, сроков реакции на инциденты и отчётности фиксируются в приложении к договору к договору и могут включать бонусно-штрафные механики.",
    ],
  },
  {
    id: "zamena",
  ...
  {
    id: "compliance",
    title: "3. Нормативка и безопасность",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Раздел «Правовая информация» (настоящий блок) и страница «Гарантии и условия поставки» согласованы по смыслу: при закупочном сравнении опирайтесь на пакет «КП + договор + приложение к договору».",
    ],
  },
];
