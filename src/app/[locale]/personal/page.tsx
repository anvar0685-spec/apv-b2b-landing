...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  return buildPageMetadata({
    ...
    pathname: "/personal",
    title: "Персонал на склад и РЦ — Москва и Московская область",
    description:
      "Грузчики, комплектовщики, кладовщики, водители ПРТ и смежные роли: отдельные страницы по городу и профилю с ориентирами ставок и сценариями смен. Аутсорсинг смен на склады и распределительные центры в Москве и МО; аутстаффинг не оказываем.",
  });
}
      ...
      <OperationalDarkHero
        ...
        kicker={
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--accent-soft)]">
            Персонал · Москва и МО
          </p>
        }
        title="Персонал"
        description={
          <p>
            Подберите профиль и город: на каждую пару — своя страница с текстом под закупку, ориентирами ₽/час и
            ссылками на калькулятор и заявку на КП. Охват — склады и РЦ в Москве и Московской области; аутстаффинг не
            оказываем.
          </p>
        }
