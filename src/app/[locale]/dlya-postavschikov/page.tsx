...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    pathname: "/dlya-postavschikov",
    title: t("dlyaPostavschikov.metaTitle"),
    description: t("dlyaPostavschikov.metaDescription"),
  });
}
...
const STEPS = [
  ...
  {
    step: "02",
    title: "Проверка документов и рисков",
...
const REQUIREMENTS = [
  ...
  "Готовность к электронному документообороту и согласованным регламентом по замене.",
  ...
  return (
    <main id="main" className="pb-24">
      <MarketingPageHero
        ...
        description="Мы наращиваем исполнение на объектах через проверенных партнёров. Ниже — прозрачный путь квалификации и этические стандарты, которые не подлежат обсуждению на объекте."
      />
