  ...
  return (
    <main id="main" className="pb-24">
      <MarketingPageHero
        kicker="Люди"
        title="Команда"
        description="Структура отражает полный цикл работы подрядчика по сменам: от коммерции до закрытия смен на объекте. Фамилии и фото добавляются после согласования с GDPR/152-ФЗ и корпоративной политикой."
      />
